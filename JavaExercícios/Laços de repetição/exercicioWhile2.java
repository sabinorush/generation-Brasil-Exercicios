...
public class exercicioWhile2 {
	...
	public static void main(String[] args) {
		...
		while (pessoas < 150) { //alterar para menos para teste.
			...
			if(sexo == 1 && temp == 2) contFNerv++; //Verifica se é Feminino e nervosa e armazena.
			if(sexo == 2 && temp == 3) contMAgre++; //Verifica se é Masculino e agressivo e armazena.
		...
		System.out.printf("\nO número de homens agressivos é: "+ contMAgre);
